export function InitSelect() {
    ...
    const langSelects = document.querySelectorAll('.lang .custom-select');
    initCustomSelects(langSelects);


    const categorySelects = document.querySelectorAll('.category-select .custom-select');
    initCustomSelects(categorySelects);
